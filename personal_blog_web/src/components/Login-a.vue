    ...
    <div class="main-box">
        <div :class="['container', 'container-register', { 'is-txl': isLogin }]">
            <form>
                ...
                <input class="form__input" type="text" v-model="registerForm.phone" placeholder="电话号码" />
                <input class="form__input" type="password" v-model="registerForm.password" placeholder="Password" />
                <div class="primary-btn" @click="regist">立即注册</div>
            </form>
        </div>
        <div
        ...
        >
            <form>
                ...
                <span class="text">or use email for registration</span>
                <input class="form__input" type="text" v-model="loginForm.phone" placeholder="电话号码" />
                <input class="form__input" type="password" v-model="loginForm.password" placeholder="Password" />
    ...
    .main-box {
        ...
        .switch {
            ...
            .switch__circle {
                ...
                box-shadow: inset 8px 8px 12px #18a058, inset -8px -8px 12px #2080f0;
                bottom: -60%;
                left: -60%;
                transition: 1.25s;
            }
